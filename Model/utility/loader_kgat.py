    ...
    def _generate_train_A_batch(self):
        ...
        def sample_neg_triples_for_h(h, r, num):
            ...
            while True:
                ...
                t = np.random.randint(
                    low=0, high=self.n_users + self.n_entities, size=1)[0]
