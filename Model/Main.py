...
if __name__ == '__main__':
    ...
    logging.basicConfig(filename=f'Log/{args.model_type}_training.log', level=logging.INFO, 
    ...
    *********************************************************
    ...
    save_path = 'Model/%soutput/%s/%s.result' % (args.proj_path,
